...
void cache_boundary(uvec3 wid, uvec3 lid) {
    ...
    if (any(greaterThanEqual(gid, u_size))) {
        ...
        s_x[1+lid.z][1+lid.y][1+lid.x] = float16_t(0.0);
        return;
    } 
...
// https://shader-playground.timjones.io/448de7cf97d13f01581c8acdcd3b3186
//   sgpr_count(22)
//   vgpr_count(24)
// Maximum # VGPR used  18, VGPRs allocated by HW:  32 (19 requested)
// 
// Instructions: 281